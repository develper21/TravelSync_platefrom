        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-2xl font-bold">TravelSync</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Your trusted partner for seamless travel experiences. We make trip planning,
              booking, and exploring destinations effortless and memorable.
            </p>

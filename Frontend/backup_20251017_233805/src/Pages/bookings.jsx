...
const Bookings = () => {
  ...
  return (
    <div>
      ...
      <div className="-mt-7 max-w-6xl mx-auto bg-white shadow-md rounded-xl flex items-center p-3 ">
        <span className="px-3 text-blue-600">
          <Mail className="w-5 h-5" />
        </span>
        <p className="flex-grow font-medium text-gray-700">
      ...
      <div className="mt-10 max-w-6xl mx-auto bg-white shadow-md rounded-xl flex flex-wrap items-center p-4 gap-4 relative">
  ...
  <div className="flex-1 min-w-[150px]">
    ...
    <input
      type="date"
      className="w-40 px-3 py-2 border rounded-lg outline-none"
    />
  </div>

  {/* Type Dropdown */}
  <div className="flex-1 min-w-[150px]">
    <label className="block text-sm font-medium text-gray-600 mb-1 -ml-38">
      Type
    </label>
    <select className=" -ml-38 w-30 px-3 py-2 border rounded-lg outline-none">
  ...
  <div className="flex items-end">
    <button className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 flex items-center mt-5">
          ...
          return (
            <div
              ...
              className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition"
               onClick={() => navigate("/bookingsdetail", { state: { place } })}
            >
              {/* Image Container */}

...
import { FaLeaf, FaLightbulb, FaLocationDot, FaPlane, FaUsers, FaMapMarkerAlt, FaStar, FaQuoteLeft, FaLinkedin, FaTwitter, FaFacebook, FaInstagram, FaGithub, FaWhatsapp } from 'react-icons/fa';
...
const About = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: <FaLocationDot className="text-3xl text-orange-500 bg-orange-100 p-2 rounded-full" />,
    },
    {
